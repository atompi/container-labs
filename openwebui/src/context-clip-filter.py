...
class Filter:
    class Valves(BaseModel):
        ...
        n_last_messages: int = Field(default=0, description="Number of last messages to retain.")
        pass
    ...
    def inlet(self, body: dict, __user__: Optional[dict] = None) -> dict:
        ...
        system_prompt = next((message for message in messages if message.get("role") == "system"), None)
